...
The function of this code is to flip the state of the LED in the interrupt service function of the timer.
...
The timer used in this experiment is the on-chip resource of ESP32S3, so there is no corresponding connection schematic diagram.
...
- Open the '05_esp_timer' example using VS Code
