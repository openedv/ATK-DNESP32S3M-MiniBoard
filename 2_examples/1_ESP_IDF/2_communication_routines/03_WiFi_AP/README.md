...
To configure ESP32-S3 as an Access Point (AP) mode, meaning to create a hotspot connection.
...
- Open the '03_WiFi_AP' example using VS Code
...
After normal operation,To display the MAC address of the connected device on the LCD.

![](../../../../1_docs/3_figures/examples/wifi_ap/01_lcd_dispaly.png)